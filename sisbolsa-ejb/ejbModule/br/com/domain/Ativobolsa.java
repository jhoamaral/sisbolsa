...
/**
 * The persistent class for the ativobolsa database table.
 * 
 */
@Entity
@Cacheable
public class Ativobolsa implements Serializable {
	...
	@OneToMany(mappedBy="ativobolsa", cascade=CascadeType.ALL,fetch=FetchType.LAZY)
	private Set<Boleto> boletos;

	//bi-directional many-to-one association to Eventofixo
	@OneToMany(mappedBy="ativobolsa",fetch=FetchType.LAZY)
	...
	@OneToOne(mappedBy="ativobolsa", cascade=CascadeType.ALL,fetch = FetchType.EAGER)
    ...
    public Ativobolsa() {
    	...
    	this.socioeconeomico.setAtivobolsa(this);
    }
